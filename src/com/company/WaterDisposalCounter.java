...
public class WaterDisposalCounter extends Counter implements Count {
    private double COST_KUB_METR = 6.696;

    public WaterDisposalCounter(double pastValue, double presentValue/*, double costKubMetr*/) {
